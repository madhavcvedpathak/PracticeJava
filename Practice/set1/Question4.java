...
public class Question4 {
    public static int minPoints(int N) {
        if (N < 3) return 4 - N; // need 4 points total
        else if (N == 3) return 2; // usually 2 extra points to form a square
        else return 0; // 4 or more points, assume square can be formed
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(minPoints(N));
    }
}
...
//OR
//(3,0) & (0,3)
//Tina doesn’t want to lose a good deal here, so better if she would go with (3,0) & (0,3). Hence 2 additional coordinates were required to cut a perfect square from that piece of cloth.
