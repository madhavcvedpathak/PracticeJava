...
// A value N is printed on each product. When the scanner reads the value N on
// the item, the product of all the digits in the value N is the price of the item.
